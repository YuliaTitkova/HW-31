...
async function getData(segment) {
  ...
  try {
    ...
    if (response.ok) {
      ...
      console.log(data);  // Логирование успешного ответа
      return data;
    } else {
...
async function postData(segment, data) {
  ...
  try {
    ...
    if (response.ok) {
      ...
      console.log(result);  // Логирование успешного ответа
      return result;
    } else {
      console.error(`Error: HTTP status ${response.status}`);
...
async function deleteData(id) {
  ...
  try {
    ...
    if (response.ok) {
      ...
      return `Failed to delete post with id ${id}. Status: ${response.status}`;
    }
  } catch (error) {
